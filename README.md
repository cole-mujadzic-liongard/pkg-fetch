A utility to fetch or build patched Node binaries used by [pkg](https://github.com/cole-mujadzic-liongard/pkg) to generate executables. This repo hosts prebuilt binaries in [Releases](https://github.com/cole-mujadzic-liongard/pkg-fetch/releases).
...
- Binaries are compiled by [Github Actions](https://github.com/cole-mujadzic-liongard/pkg-fetch/actions)
...
- Hashes of binaries are hardcoded in [source](https://github.com/cole-mujadzic-liongard/pkg-fetch/blob/HEAD/lib/expected.ts)
...
- GPG-signed hashes are available in [Releases](https://github.com/cole-mujadzic-liongard/pkg-fetch/releases)
